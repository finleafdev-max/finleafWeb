  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-6 left-6 z-50">
        <Link href="tel:+919599762894" className="bg-green-500 text-white p-4 rounded-full shadow-xl hover:bg-green-600 transition-all duration-300 hover:scale-110">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Link href="https://wa.me/919599762894" className="bg-green-500 text-white p-4 rounded-full shadow-xl hover:bg-green-600 transition-all duration-300 hover:scale-110">
