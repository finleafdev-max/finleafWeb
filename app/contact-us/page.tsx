          ...
          >
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                {/* India Head Office */}
                <motion.div
                  className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 w-full max-w-sm"
                  initial={{ opacity: 0, y: 30 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">India (Head Office)</h3>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">India (Mumbai)</h3>
                  <p className="text-gray-600 text-sm leading-relaxed text-center">
                    A-304, 3rd Floor, Dalamal Tower, Free Press Journal Marg, Nariman Point, Mumbai – 400021, Maharashtra, India
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">USA Branch</h3>
                  <p className="text-gray-600 text-sm leading-relaxed text-center">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">UAE Branch</h3>
                  <p className="text-gray-600 text-sm leading-relaxed text-center">
                    Business Center, Al Messaned, UAE
                  </p>
                </motion.div>
              </div>
            </div>
