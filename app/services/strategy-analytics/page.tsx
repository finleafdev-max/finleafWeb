...
const features = [
  {
    ...
    description: 'Comprehensive strategic planning and business strategy development for sustainable growth.',
    icon: '🎯'
  },
  {
  ...
  },
  {
    ...
    description: 'In-depth market research and competitive analysis for strategic insights.',
    icon: '🔍'
  },
  {
    title: 'Performance Metrics',
    description: 'Performance measurement and KPI development for business optimization.',
    icon: '📈'
  }
];
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-gradient-to-br from-amber-600 via-amber-500 to-yellow-500">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center text-white">
            ...
            >
              Drive business success through strategic planning and data-driven analytics consulting.
            </motion.p>
            <motion.div 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our Strategy & Analytics consulting services help organizations make data-driven decisions 
                and develop effective business strategies. We provide comprehensive solutions for strategic 
                planning, data analytics, market research, and performance optimization.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                With expertise in strategic planning and data analytics, our team helps businesses leverage 
                insights to optimize performance, identify growth opportunities, and achieve sustainable 
      ...
      <section className="py-24 bg-gradient-to-br from-amber-50 to-yellow-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Our Strategy & Analytics Services
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive strategic planning and data analytics solutions
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-8">
                Why Choose Our Strategy & Analytics Services?
              </h2>
            ...
            >
              ...
              <p className="text-lg mb-6 opacity-90">
                Contact our expert team today to discuss your strategy and analytics needs and get a personalized solution.
              </p>
              <div className="space-y-4">
                <Link
                  href="/contact"
