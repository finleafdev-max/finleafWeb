...
const features = [
  {
    ...
    description: 'Comprehensive talent management strategies for attracting, developing, and retaining top talent.',
    icon: '👥'
  },
  {
    title: 'HR Strategy',
    description: 'Strategic human resources planning and organizational development consulting.',
    icon: '📋'
  },
  {
    title: 'Performance Management',
    description: 'Performance management systems and employee development programs.',
    icon: '📊'
  },
  {
    title: 'Organizational Development',
    description: 'Organizational development and change management consulting services.',
    icon: '🏢'
  }
];
      ...
      <section className="relative h-96 bg-gradient-to-br from-amber-600 via-amber-500 to-yellow-500">
        ...
        <div className="relative max-w-7xl mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center text-white">
            ...
            >
              Maximize your organization's potential through strategic human capital consulting and talent management.
            </motion.p>
            <motion.div 
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Unlock Your Human Capital Potential
              </h2>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Our Human Capital consulting services help organizations optimize their most valuable asset - 
                their people. We provide comprehensive solutions for talent management, HR strategy, 
                performance management, and organizational development.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                With expertise in human resources and organizational development, our team helps businesses 
                attract, develop, and retain top talent while creating high-performance cultures that drive 
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive human capital and talent management solutions
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-gray-900 mb-8">
                Why Choose Our Human Capital Services?
              </h2>
            ...
            >
              ...
              <p className="text-lg mb-6 opacity-90">
                Contact our expert team today to discuss your human capital needs and get a personalized solution.
              </p>
              <div className="space-y-4">
                <Link
                  href="/contact"
